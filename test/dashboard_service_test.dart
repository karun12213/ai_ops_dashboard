...
void main() {
  test('loads the exact authenticated date-scoped Dashboard contract', () async {
      ...
      client: MockClient((request) async {
        ...
        expect(
          ...
          Uri.parse(
            ...
            '&workspace_id=workspace-1&location_id=location-1&activity_limit=10',
          ),
        );
        expect(
  ...
  test('rejects an out-of-range activity limit before requesting', () async {
